...
if __name__ == "__main__":
    ...
    while(True):
        ...
        comm_exec, comm_opt = comm_analyze(comm_exec) 
        command = {"id": comm_id, "branching_factor": comm_branch, "after": comm_after, "executable": comm_exec, "options": comm_opt}
        commands.append(command)
        answ = raw_input("Do you want to load another module (y/n)? ")
        print comm_id, comm_branch, comm_after, comm_exec
        if check_yn(answ) == False:
            break
        i += 1
